...
abstract: "Discrete choice models are implemented as mixed-effects
  baseline-category logit models to analyze the variation in habitat selection
  ...
  functional response curves that further can be fitted by using Holling’s formulas. \n \n \n"
editor_options: 
